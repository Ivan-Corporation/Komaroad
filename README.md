...
<li>На прогрессе что-то навроде степпера с основными компонентами дерева роадмапы т.е. на общем плане карточек прогресс, а на отдельной странице с картой степпер с функцией которая будет одновременно изменять прогресс бар на главной!</li>
<li>React flow?</li>
